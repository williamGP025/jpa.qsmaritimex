...
import mx.tab.wgp.qsmaritimex.entidades.nominacion.ArrivalInformation;
import mx.tab.wgp.qsmaritimex.entidades.nominacion.CargoType;
import mx.tab.wgp.qsmaritimex.entidades.nominacion.Port;
import mx.tab.wgp.qsmaritimex.entidades.nominacion.ScaleType;
import mx.tab.wgp.qsmaritimex.entidades.nominacion.Vessel;
import mx.tab.wgp.qsmaritimex.entidades.nominacion.VesselStatus;
...
public class ItineraryJpaController implements Serializable {
    ...
    public void edit(Itinerary itinerary) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                BigDecimal id = itinerary.getItineraryId();
    ...
    public Itinerary findItinerary(BigDecimal id) {
        EntityManager em = getEntityManager();
        try {
