...
import mx.tab.wgp.qsmaritimex.entidades.bitacora.LogTokenAudit;
...
public class LogTokenAuditJpaController implements Serializable {
    ...
    public void edit(LogTokenAudit logTokenAudit) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                BigDecimal id = logTokenAudit.getLogTokenAuditId();
    ...
    public LogTokenAudit findLogTokenAudit(BigDecimal id) {
        EntityManager em = getEntityManager();
        try {
