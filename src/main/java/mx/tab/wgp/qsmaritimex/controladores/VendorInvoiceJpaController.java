    ...
    public void create(VendorInvoice vendorInvoice) {
        ...
        try {
            ...
            for (ServiceOrderService serviceOrderServiceCollectionServiceOrderService : vendorInvoice.getServiceOrderServiceCollection()) {
                VendorInvoice oldVendorInvoiceIDOfServiceOrderServiceCollectionServiceOrderService = serviceOrderServiceCollectionServiceOrderService.getVendorInvoiceID();
                serviceOrderServiceCollectionServiceOrderService.setVendorInvoiceID(vendorInvoice);
                serviceOrderServiceCollectionServiceOrderService = em.merge(serviceOrderServiceCollectionServiceOrderService);
                if (oldVendorInvoiceIDOfServiceOrderServiceCollectionServiceOrderService != null) {
                    oldVendorInvoiceIDOfServiceOrderServiceCollectionServiceOrderService.getServiceOrderServiceCollection().remove(serviceOrderServiceCollectionServiceOrderService);
                    oldVendorInvoiceIDOfServiceOrderServiceCollectionServiceOrderService = em.merge(oldVendorInvoiceIDOfServiceOrderServiceCollectionServiceOrderService);
                }
            }
            for (ServiceOrderService serviceOrderServiceCollection1ServiceOrderService : vendorInvoice.getServiceOrderServiceCollection1()) {
                VendorInvoice oldVendorInvoiceOldIDOfServiceOrderServiceCollection1ServiceOrderService = serviceOrderServiceCollection1ServiceOrderService.getVendorInvoiceOldID();
                serviceOrderServiceCollection1ServiceOrderService.setVendorInvoiceOldID(vendorInvoice);
                serviceOrderServiceCollection1ServiceOrderService = em.merge(serviceOrderServiceCollection1ServiceOrderService);
                if (oldVendorInvoiceOldIDOfServiceOrderServiceCollection1ServiceOrderService != null) {
                    oldVendorInvoiceOldIDOfServiceOrderServiceCollection1ServiceOrderService.getServiceOrderServiceCollection1().remove(serviceOrderServiceCollection1ServiceOrderService);
                    oldVendorInvoiceOldIDOfServiceOrderServiceCollection1ServiceOrderService = em.merge(oldVendorInvoiceOldIDOfServiceOrderServiceCollection1ServiceOrderService);
                }
            }
        ...
        try {
            ...
            for (ServiceOrderService serviceOrderServiceCollectionOldServiceOrderService : serviceOrderServiceCollectionOld) {
                if (!serviceOrderServiceCollectionNew.contains(serviceOrderServiceCollectionOldServiceOrderService)) {
                    serviceOrderServiceCollectionOldServiceOrderService.setVendorInvoiceID(null);
            ...
            for (ServiceOrderService serviceOrderServiceCollectionNewServiceOrderService : serviceOrderServiceCollectionNew) {
                if (!serviceOrderServiceCollectionOld.contains(serviceOrderServiceCollectionNewServiceOrderService)) {
                    VendorInvoice oldVendorInvoiceIDOfServiceOrderServiceCollectionNewServiceOrderService = serviceOrderServiceCollectionNewServiceOrderService.getVendorInvoiceID();
                    serviceOrderServiceCollectionNewServiceOrderService.setVendorInvoiceID(vendorInvoice);
                    serviceOrderServiceCollectionNewServiceOrderService = em.merge(serviceOrderServiceCollectionNewServiceOrderService);
                    if (oldVendorInvoiceIDOfServiceOrderServiceCollectionNewServiceOrderService != null && !oldVendorInvoiceIDOfServiceOrderServiceCollectionNewServiceOrderService.equals(vendorInvoice)) {
                        oldVendorInvoiceIDOfServiceOrderServiceCollectionNewServiceOrderService.getServiceOrderServiceCollection().remove(serviceOrderServiceCollectionNewServiceOrderService);
                        oldVendorInvoiceIDOfServiceOrderServiceCollectionNewServiceOrderService = em.merge(oldVendorInvoiceIDOfServiceOrderServiceCollectionNewServiceOrderService);
                    }
                }
            }
            for (ServiceOrderService serviceOrderServiceCollection1OldServiceOrderService : serviceOrderServiceCollection1Old) {
                if (!serviceOrderServiceCollection1New.contains(serviceOrderServiceCollection1OldServiceOrderService)) {
                    serviceOrderServiceCollection1OldServiceOrderService.setVendorInvoiceOldID(null);
            ...
            for (ServiceOrderService serviceOrderServiceCollection1NewServiceOrderService : serviceOrderServiceCollection1New) {
                if (!serviceOrderServiceCollection1Old.contains(serviceOrderServiceCollection1NewServiceOrderService)) {
                    VendorInvoice oldVendorInvoiceOldIDOfServiceOrderServiceCollection1NewServiceOrderService = serviceOrderServiceCollection1NewServiceOrderService.getVendorInvoiceOldID();
                    serviceOrderServiceCollection1NewServiceOrderService.setVendorInvoiceOldID(vendorInvoice);
                    serviceOrderServiceCollection1NewServiceOrderService = em.merge(serviceOrderServiceCollection1NewServiceOrderService);
                    if (oldVendorInvoiceOldIDOfServiceOrderServiceCollection1NewServiceOrderService != null && !oldVendorInvoiceOldIDOfServiceOrderServiceCollection1NewServiceOrderService.equals(vendorInvoice)) {
                        oldVendorInvoiceOldIDOfServiceOrderServiceCollection1NewServiceOrderService.getServiceOrderServiceCollection1().remove(serviceOrderServiceCollection1NewServiceOrderService);
                        oldVendorInvoiceOldIDOfServiceOrderServiceCollection1NewServiceOrderService = em.merge(oldVendorInvoiceOldIDOfServiceOrderServiceCollection1NewServiceOrderService);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            for (ServiceOrderService serviceOrderServiceCollectionServiceOrderService : serviceOrderServiceCollection) {
                serviceOrderServiceCollectionServiceOrderService.setVendorInvoiceID(null);
                serviceOrderServiceCollectionServiceOrderService = em.merge(serviceOrderServiceCollectionServiceOrderService);
            }
            ...
            for (ServiceOrderService serviceOrderServiceCollection1ServiceOrderService : serviceOrderServiceCollection1) {
                serviceOrderServiceCollection1ServiceOrderService.setVendorInvoiceOldID(null);
                serviceOrderServiceCollection1ServiceOrderService = em.merge(serviceOrderServiceCollection1ServiceOrderService);
            }
