...
import mx.tab.wgp.qsmaritimex.entidades.bitacora.LogProcesSuccessful;
...
public class LogProcesSuccessfulJpaController implements Serializable {
    ...
    public void edit(LogProcesSuccessful logProcesSuccessful) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                BigDecimal id = logProcesSuccessful.getLogProcesSuccessfulId();
    ...
    public LogProcesSuccessful findLogProcesSuccessful(BigDecimal id) {
        EntityManager em = getEntityManager();
        try {
